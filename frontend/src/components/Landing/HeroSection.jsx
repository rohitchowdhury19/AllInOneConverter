  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center">
        ...
        <h1 className="text-5xl sm:text-7xl lg:text-[92px] font-black tracking-tight leading-[0.95]">
          The Modern Toolkit
          <br />
        ...
        <p className="max-w-3xl mx-auto mt-8 text-lg sm:text-xl text-slate-600 dark:text-slate-400 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-5 mt-12">
          ...
          <div className="px-6 py-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl">
        ...
        <div className="hidden lg:flex justify-center gap-4 flex-wrap mt-16">
          {[
            ...
            <div
              key={tool.label}
              className="flex items-center gap-2 px-4 py-3 rounded-2xl bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border border-slate-200 dark:border-slate-800 shadow-lg hover:scale-105 transition-all"
            >
              {tool.icon}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-20 max-w-4xl mx-auto">
          {[
            ...
            <div
              key={stat.label}
              className="rounded-3xl p-6 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200 dark:border-slate-800 shadow-lg"
            >
